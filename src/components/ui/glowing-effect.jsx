  ...
  ({
    ...
    return (
      <>
        <div
          className={cn(
            "glowing-effect__border pointer-events-none absolute -inset-px hidden rounded-[inherit] border opacity-0 transition-opacity",
            glow && "opacity-100",
        ...
        >
          <div
            className={cn(
              "glow glowing-effect__glow rounded-[inherit]",
