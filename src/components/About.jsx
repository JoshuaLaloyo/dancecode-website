  ...
  const team = [
    {
      ...
      description:
        'With expertise in modern web technologies, Jay transforms complex ideas into elegant, performant solutions.',
      badge: 'Core',
      meta: 'DanceCode Team',
      phone: '+256767934191',
    },
      ...
      <div className="container">
        <div className="about-header">
          <h2 className="section-title">
            Meet <span className="gradient-text">DanceCode</span>
          </h2>
          <p className="section-description">
            We're a driven team of web professionals committed to delivering outstanding results.
            By combining technical expertise with creative vision, we build websites that not only
            look remarkable but perform flawlessly.
          </p>
        </div>
              ...
              <div className="team-card__surface">
                ...
                <div className="team-actions">
                  ...
                  >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                      <path
                        d="M21 12a8.5 8.5 0 0 1-8.5 8.5H7l-4 3 1.4-4.6A8.5 8.5 0 1 1 21 12Z"
                        stroke="currentColor"
                        strokeWidth="2"
                        fill="none"
